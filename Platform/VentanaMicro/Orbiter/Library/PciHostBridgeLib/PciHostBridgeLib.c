...
{
  EFI_PHYSICAL_ADDRESS  EcamBase[] = { ORBITER_PCIE_ECAM };
  UINT64                EcamSize[] = { ORBITER_PCIE_ECAM_SIZE };
  EFI_PHYSICAL_ADDRESS  Mmio32Base[] = { ORBITER_PCIE_MMIO32 };
  UINT32                Mmio32Size[] = { ORBITER_PCIE_MMIO32_SIZE };
  EFI_PHYSICAL_ADDRESS  Mmio64Base[] = { ORBITER_PCIE_MMIO64 };
  UINT64                Mmio64Size[] = { ORBITER_PCIE_MMIO64_SIZE };
  EFI_STATUS            Status;
  UINT32                Idx;
