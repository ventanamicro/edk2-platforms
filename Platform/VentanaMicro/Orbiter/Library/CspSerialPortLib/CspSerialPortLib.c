  ...
  )
{
  ...
  return CspUartInitializePort (
           (UINTN)FixedPcdGet64 (PcdUartBase),
           &BaudRate,
           &Parity,
           &DataBits,
           &StopBits
...
)
{
  ...
  for (i = 0; i <  NumberOfBytes; i++) {
    CspUartPutChar ((UINTN)PcdGet64 (PcdUartBase), Buffer[i]);
  }
  return i;
}
...
)
{
  UINTN i;
  for (i = 0; i < NumberOfBytes; i++) {
    Buffer[i] = CspUartGetChar ((UINTN)PcdGet64 (PcdUartBase));
  }
  return i;
}
...
{
  return (MmioRead32 ((UINTN)(PcdGet64 (PcdUartBase + CSP_UART_CSR))) &
  ...
  )
{
  ...
  Bits = MmioRead32 (PcdGet64 (PcdUartBase) + CSP_UART_MCR);
  ...
  MmioWrite32 ((PcdGet64 (PcdUartBase) + CSP_UART_MCR), Bits);
  ...
  )
{
  ...
  ModemCtrlReg = MmioRead32 ((UINTN)(PcdGet64 (PcdUartBase) +
                                     CSP_UART_MCR));
  ModemStatusReg = MmioRead32 ((UINTN)(PcdGet64 (PcdUartBase) +
                                       CSP_UART_MSR));
  ChanStatusReg = MmioRead32 ((UINTN)(PcdGet64 (PcdUartBase) +
                                       CSP_UART_CSR));
  ...
  )
{
  ...
  // Set baud rate
  UINT32 SelClk = MmioRead32 ((UINTN)(PcdGet64 (PcdUartClk)));
  UINT32 BDiv = 0;
