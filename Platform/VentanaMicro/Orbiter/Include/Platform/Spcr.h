...
#define EFI_ACPI_OEM_SPCR_REVISION 0x00000004 // TBD

#define EFI_ACPI_INTERFACE_TYPE                     0x16 // 16550 compatible interface.

//
// Base Address
//
#define EFI_ACPI_BASE_ADDRESS_ADDRESS_SPACE_ID      EFI_ACPI_6_2_SYSTEM_MEMORY
#define EFI_ACPI_BASE_ADDRESS_BIT_WIDTH             0x08
#define EFI_ACPI_BASE_ADDRESS_BIT_OFFSET            0x00
#define EFI_ACPI_BASE_ADDRESS_ACCESS_SIZE           0x01
#define EFI_ACPI_BASE_ADDRESS_ADDRESS               0x4219C000

#define EFI_ACPI_INTERRUPT_TYPE                     0x10 // PLIC/APLIC
#define EFI_ACPI_IRQ                                0x00 // Updated at run time
#define EFI_ACPI_GLOBAL_SYSTEM_INTERRUPT            0x25 // GSI
