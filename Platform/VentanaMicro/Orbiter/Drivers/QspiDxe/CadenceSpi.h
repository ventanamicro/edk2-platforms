...
#define CAD_QSPI_SRAM_FIFO_ENTRY_COUNT                (512 / sizeof(UINT32))
...
#define CAD_QSPI_PAGE_SIZE                            FixedPcdGet32 (PcdFlashPageSize)
#define CAD_QSPI_SUBSECTOR_SIZE                       FixedPcdGet32 (PcdFlashSectorSize)
#define CAD_QSPI_BANK_SIZE                            FixedPcdGet32 (PcdFlashBankSize)
...
#define CONFIG_QSPI_ADDR_BYTES                        2
#define CONFIG_QSPI_BYTES_PER_DEV                     256
#define CONFIG_BYTES_PER_BLOCK                        16

VOID CadQspiUpdateBaseAddress (UINT64 BaseAddress);
INTN CadQspiInit (UINT64 BaseAddress, UINT32 ClkPhase,
