  ...
  )
{
  ...
  if (CompareGuid (Dev->Type, &gOrbiterNonDiscoverableRuntimeSysI2cMasterGuid)) {
    Status = EFI_SUCCESS;
  } else {
...
EFI_STATUS
EFIAPI
I2cDriverBindingStart (
  IN EFI_DRIVER_BINDING_PROTOCOL  *This,
  IN EFI_HANDLE                   ControllerHandle,
  IN EFI_DEVICE_PATH_PROTOCOL     *RemainingDevicePath OPTIONAL
  )
{
  return I2cInit (This->DriverBindingHandle, ControllerHandle);
}
...
{
  return I2cRelease (This->DriverBindingHandle, ControllerHandle);
}


EFI_DRIVER_BINDING_PROTOCOL  gI2cDriverBinding = {
  I2cDriverBindingSupported,
  I2cDriverBindingStart,
  I2cDriverBindingStop,
  0xa,
  ...
  )
{
  ...
  Status = EfiLibInstallDriverBindingComponentName2 (
             ImageHandle, SystemTable, &gI2cDriverBinding, ImageHandle,
             NULL, &gI2cDriverComponentName2);
  ASSERT_EFI_ERROR (Status);

  DEBUG ((DEBUG_INFO, "*** Installed  I2C UEFI driver! ***\n"));
