...
{
  EFI_PHYSICAL_ADDRESS  EcamBase[] = { VENTANASYNTH_PCIE_ECAM };
  UINT64                EcamSize[] = { VENTANASYNTH_PCIE_ECAM_SIZE };
  EFI_PHYSICAL_ADDRESS  Mmio32Base[] = { VENTANASYNTH_PCIE_MMIO32 };
  UINT32                Mmio32Size[] = { VENTANASYNTH_PCIE_MMIO32_SIZE };
  EFI_PHYSICAL_ADDRESS  Mmio64Base[] = { VENTANASYNTH_PCIE_MMIO64 };
  UINT64                Mmio64Size[] = { VENTANASYNTH_PCIE_MMIO64_SIZE };
  EFI_STATUS            Status;
  UINT32                Idx;
