  ...
  )
{
  ...
  EFI_PHYSICAL_ADDRESS  EcamBase[] = { THUNDERHILL_PCIE0_ECAM };
  UINT64                EcamSize[] = { THUNDERHILL_PCIE0_ECAM_SIZE };
  EFI_PHYSICAL_ADDRESS  Mmio32Base[] = { THUNDERHILL_PCIE0_MMIO32 };
  UINT32                Mmio32Size[] = { THUNDERHILL_PCIE0_MMIO32_SIZE };
  EFI_STATUS            Status;
  UINT32                Idx;
