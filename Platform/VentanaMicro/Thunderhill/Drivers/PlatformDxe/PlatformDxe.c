...
STATIC CONST EFI_GUID mThunderhillAcpiTableFile = { 0xa9b0d3e0, 0x9569, 0x4bc4, { 0xad, 0x25, 0x4d, 0x6c, 0x10, 0x9e, 0x88, 0xe1 } };
  ...
  )
{
  ...
  Status = LocateAndInstallAcpiFromFv (&mThunderhillAcpiTableFile);
  if (EFI_ERROR (Status)) {
    return;
  }
